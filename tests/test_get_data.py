...
QLIB_DIR = DATA_DIR.joinpath("qlib_bak")
...
class TestGetData(unittest.TestCase):
    ...
    def test_0_qlib_data(self):
        ...
        self.assertListEqual(list(df.columns), self.FIELDS, "get qlib_bak data failed")
        self.assertFalse(df.dropna().empty, "get qlib_bak data failed")
