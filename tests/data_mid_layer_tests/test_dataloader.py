...
from qlib_bak.data.dataset.loader import NestedDataLoader, QlibDataLoader
from qlib_bak.data.dataset.handler import DataHandlerLP
from qlib_bak.contrib.data.loader import Alpha158DL, Alpha360DL
...
class TestDataLoader(unittest.TestCase):
    ...
    def test_nested_data_loader(self):
        ...
        nd = NestedDataLoader(
            dataloader_l=[
                {
                    "class": "qlib_bak.contrib.data.loader.Alpha158DL",
                },
                {
                    "class": "qlib_bak.contrib.data.loader.Alpha360DL",
        ...
        nested_data_loader = NestedDataLoader(
            dataloader_l=[
                ...
                {
                    "class": "qlib_bak.data.dataset.loader.StaticDataLoader",
