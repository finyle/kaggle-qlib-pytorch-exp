...
import fire
import qlib_bak
from qlib_bak.model.trainer import DelayTrainerR, DelayTrainerRM, TrainerR, TrainerRM, end_task_train, task_train
from qlib_bak.workflow import R
from qlib_bak.workflow.online.strategy import RollingStrategy
from qlib_bak.workflow.task.gen import RollingGen
from qlib_bak.workflow.online.manager import OnlineManager
from qlib_bak.tests.config import CSI100_RECORD_XGBOOST_TASK_CONFIG_ROLLING, CSI100_RECORD_LGB_TASK_CONFIG_ROLLING
from qlib_bak.workflow.task.manage import TaskManager


class RollingOnlineExample:
    def __init__(
        self,
        provider_uri="~/.qlib_bak/qlib_data/cn_data",
        region="cn",
        ...
        qlib_bak.init(provider_uri=provider_uri, region=region, mongo=mongo_conf)
        self.tasks = tasks
