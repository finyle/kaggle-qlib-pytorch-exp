...
from qlib_bak.model.trainer import task_train
from qlib_bak.workflow.online.utils import OnlineToolR
...
task["record"] = {
    "class": "SignalRecord",
    "module_path": "qlib_bak.workflow.record_temp",
}


class UpdatePredExample:
    def __init__(
        self, provider_uri="~/.qlib_bak/qlib_data/cn_data", region=REG_CN, experiment_name="online_srv", task_config=task
    ):
        qlib_bak.init(provider_uri=provider_uri, region=region)
