...
[1706497:MainThread](2021-12-07 14:08:30,263) INFO - qlib_bak.workflow - [record_temp.py:441] - Portfolio analysis record 'port_analysis_30minute.
...
[1706497:MainThread](2021-12-07 14:08:30,277) INFO - qlib_bak.workflow - [record_temp.py:441] - Portfolio analysis record 'port_analysis_5minute.p
...
[1706497:MainThread](2021-12-07 14:08:30,287) INFO - qlib_bak.workflow - [record_temp.py:466] - Indicator analysis record 'indicator_analysis_1day
.pkl' has been saved as the artifact of the Experiment 2
...
pa   0.000324
pos  0.542882
[1706497:MainThread](2021-12-07 14:08:30,293) INFO - qlib_bak.workflow - [record_temp.py:466] - Indicator analysis record 'indicator_analysis_30mi
...
pa   0.000037
pos  0.500806
[1706497:MainThread](2021-12-07 14:08:30,302) INFO - qlib_bak.workflow - [record_temp.py:466] - Indicator analysis record 'indicator_analysis_5min
...
pa   0.000000
pos  0.000000
[1706497:MainThread](2021-12-07 14:08:30,627) INFO - qlib_bak.timer - [log.py:113] - Time cost: 0.014s | waiting `async_log` Done
"""
...
from qlib_bak.config import HIGH_FREQ_CONFIG
from qlib_bak.data import D
from qlib_bak.utils import exists_qlib_data, init_instance_by_config, flatten_dict
from qlib_bak.workflow import R
from qlib_bak.workflow.record_temp import SignalRecord, PortAnaRecord
from qlib_bak.tests.data import GetData
from qlib_bak.backtest import collect_data
...
class NestedDecisionExecutionWorkflow:
    ...
    task = {
        "model": {
            "class": "LGBModel",
            "module_path": "qlib_bak.contrib.model.gbdt",
            "kwargs": {
                "loss": "mse",
        ...
        "dataset": {
            "class": "DatasetH",
            "module_path": "qlib_bak.data.dataset",
            "kwargs": {
                "handler": {
                    "class": "Alpha158",
                    "module_path": "qlib_bak.contrib.data.handler",
    ...
    port_analysis_config = {
        "executor": {
            ...
            "module_path": "qlib_bak.backtest.executor",
            "kwargs": {
                "time_per_step": "day",
                "inner_executor": {
                    "class": "NestedExecutor",
                    ...
                    "kwargs": {
                        ...
                        "inner_strategy": {
                            "class": "TWAPStrategy",
                            "module_path": "qlib_bak.contrib.strategy.rule_strategy",
                        },
                        "generate_portfolio_metrics": True,
                        "indicator_config": {
                            "show_indicator": True,
    ...
    def _init_qlib(self):
        """initialize qlib_bak"""
        provider_uri_day = "~/.qlib_bak/qlib_data/cn_data"  # target_dir
        ...
        qlib_bak.init(provider_uri=provider_uri_map, dataset_cache=None, expression_cache=None)
    ...
    def backtest(self):
        ...
        strategy_config = {
            ...
            "module_path": "qlib_bak.contrib.strategy.signal_strategy",
            "kwargs": {
        ...
        # from qlib_bak.contrib.report import analysis_position
    ...
    def backtest_only_daily(self):
        ...
        .. code-block:: shell
            ...
            [1724971:MainThread](2021-12-07 16:24:31,156) INFO - qlib_bak.workflow - [record_temp.py:441] - Portfolio analysis record 'port_analysis_1day.pkl'
            ...
            [1724971:MainThread](2021-12-07 16:24:31,170) INFO - qlib_bak.workflow - [record_temp.py:466] - Indicator analysis record 'indicator_analysis_1day.
            pkl' has been saved as the artifact of the Experiment 2
            'The following are analysis results of indicators(1day).'
                 value
            ffr    1.0
            pa     0.0
            pos    0.0
            [1724971:MainThread](2021-12-07 16:24:31,188) INFO - qlib_bak.timer - [log.py:113] - Time cost: 0.007s | waiting `async_log` Done
