...
trn_input = './input/equity-post-HCT-survival-predictions/train.csv'
tst_input = './input/equity-post-HCT-survival-predictions/test.csv'
sub_input = './input/equity-post-HCT-survival-predictions/sample_submission.csv'
...
data_dict = './input/equity-post-HCT-survival-predictions/data_dictionary.csv'
