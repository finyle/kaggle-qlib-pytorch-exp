...
class InfoCollector:
    ...
    - NOTE: please avoid running this script in the project folder which contains `qlib_bak`
    """
    ...
    def qlib(self):
        """collect qlib_bak related info"""
        print("Qlib version: {}".format(qlib_bak.__version__))
        REQUIRED = [
            "numpy",
            "pandas",
            "scipy",
