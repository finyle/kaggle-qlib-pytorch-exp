...
class Run(BaseRun):
    ...
    def download_data(
        ...
        ---------
            # get daily data
            $ python collector.py download_data --source_dir ~/.qlib_bak/crypto_data/source/1d --start 2015-01-01 --end 2021-11-30 --delay 1 --interval 1d
        """
    ...
    def normalize_data(self, date_field_name: str = "date", symbol_field_name: str = "symbol"):
        ...
        Examples
        ---------
            $ python collector.py normalize_data --source_dir ~/.qlib_bak/crypto_data/source/1d --normalize_dir ~/.qlib_bak/crypto_data/source/1d_nor --interval 1d --date_field_name date
        """
