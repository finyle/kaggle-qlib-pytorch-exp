...
from qlib_bak.utils import code_to_fname
...
class BaseRun(abc.ABC):
    ...
    def download_data(
        ...
        **kwargs,
        ...
        ---------
            # get daily data
            $ python collector.py download_data --source_dir ~/.qlib_bak/instrument_data/source --region CN --start 2020-11-01 --end 2020-11-10 --delay 0.1 --interval 1d
            # get 1m data
            $ python collector.py download_data --source_dir ~/.qlib_bak/instrument_data/source --region CN --start 2020-11-01 --end 2020-11-10 --delay 0.1 --interval 1m
        """
    ...
    def normalize_data(self, date_field_name: str = "date", symbol_field_name: str = "symbol", **kwargs):
        ...
        Examples
        ---------
            $ python collector.py normalize_data --source_dir ~/.qlib_bak/instrument_data/source --normalize_dir ~/.qlib_bak/instrument_data/normalize --region CN --interval 1d
        """
