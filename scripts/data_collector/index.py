...
class IndexBase:
    ...
    def __init__(
        ...
        index_name: str
            index name
        qlib_dir: str
            qlib_bak directory, by default Path(__file__).resolve().parent.joinpath("qlib_data")
        freq: str
        ...
        self.cache_dir = Path(f"~/.cache/qlib_bak/index/{self.index_name}").expanduser().resolve()
    ...
    def save_new_companies(self):
        ...
        Examples
        -------
            $ python collector.py save_new_companies --index_name CSI300 --qlib_dir ~/.qlib_bak/qlib_data/cn_data
        """
    ...
    def parse_instruments(self):
        ...
        Examples
        -------
            $ python collector.py parse_instruments --index_name CSI300 --qlib_dir ~/.qlib_bak/qlib_data/cn_data
        """
